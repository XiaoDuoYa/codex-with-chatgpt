...
<div class="card">
  ...
  <p class="hint">The pairing code was generated by Codex on this computer.<br>It expires within 30 minutes by default; enter it immediately.</p>
</div>
</body>
</html>`;
}
...
export function createOAuthRouter(deps: OAuthDeps): Router {
  ...
  router.get("/oauth/authorize", (req, res) => {
    ...
    setAuthSecurityHeaders(res, redirectUri);
    res
      .status(200)
      .type("html")
  ...
  router.post("/oauth/authorize", urlencoded({ extended: false }), (req, res) => {
    ...
    if (!verdict.ok) {
      ...
      setAuthSecurityHeaders(res, request.redirectUri);
      res
